...
/**
 * Spy system that teleports packets to exit from any spy system in the network (including itself).
 * Destroys confidential packets completely and reverts protected packets to their original type.
 * Non-protected, non-confidential packets are teleported to a random spy system and exit from there.
 */
public class SpySystem extends System {
    ...
    /**
     * Teleports a packet to exit from a target spy system.
     * The packet appears directly at the output ports of the target system.
     */
    ...
    /**
     * Finds the best output port for a packet (compatible and empty preferred).
     */
